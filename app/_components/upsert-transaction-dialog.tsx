...
import { addTransaction } from "../_actions/upsert-transaction";
...
const UpsertTransactionDialog = ({
  ...
  }, [defaultValues, transactionId, form]);
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Transação..." {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <DatePicker
                    ...
                    onChange={
                      field.onChange
                        ? (date) => field.onChange(date ? new Date(date) : date)
                        : undefined
                    }
                  />
                  <FormMessage />
